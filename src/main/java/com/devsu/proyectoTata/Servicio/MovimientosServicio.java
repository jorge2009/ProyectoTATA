 ...
 */
package com.devsu.proyectoTata.Servicio;
...
import com.devsu.proyectoTata.Repositorio.CuentaRepositorio;
import com.devsu.proyectoTata.Repositorio.MovimientosRepositorio;
...
public ArrayList<Movimientos> MovimientosPorCliente(int codCli){
ArrayList<Movimientos> listaMov=new ArrayList<>();
ArrayList<Movimientos> listaMov2=new ArrayList<>();
listaMov=(ArrayList<Movimientos>)movimientosRepositorio.findAll();
for(Movimientos mov: listaMov){
    Movimientos movi=new Movimientos();
    if(mov.getCuenta().getCliente().getClienteId()==codCli){
       movi.setMovimientoId(mov.getMovimientoId());
        listaMov2.add(movi);
    }
